      ...
      <div class="row px-4 m-0">
        <div class="col-md-4 col-sm-12 px-4 py-2">
          ...
          <div class="preview-card">
            <div :id="`carousel-preview`" class="carousel slide"
              :class="{ 'empty-carousel': previewImages.length === 0 }" data-bs-ride="carousel">
              <div class="carousel-inner">
              ...
              <button class="carousel-control-prev" type="button" data-bs-target="#carousel-preview"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
              </button>
              <button class="carousel-control-next" type="button" data-bs-target="#carousel-preview"
                data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
              </button>
        ...
        <div class="col-md-8 col-sm-12 px-4 py-2">
          ...
          <form @submit.prevent="updatePost" class="create-post-form">
            ...
            <button type="submit" class="col-12 btn py-2 submit-btn" :disabled="!isFormValid || isSubmitting">
              {{ isSubmitting ? 'Saving...' : 'Save Changes' }}
            </button>
          </form>

          <button @click="deletePost" class="col-12 btn py-2 delete-btn" :disabled="!isFormValid || isDeleting">
...
const updatePost = async () => {
  ...
  try {
    ...
    showCustomAlert('Failed to update post. Please try again.', 'error');
  } finally {
